...
class Point {
  ...
  static sameSides(side: number): Point {
...
let p3: Point = Point.sameSides(10);
...
let tuple: Tuple<string, string> = pairToTuple({ item1: "hello", item2: "world" });
...
let tyrone = 'Tyrone';
let greeting = `Hi ${tyrone}, how are you?`
